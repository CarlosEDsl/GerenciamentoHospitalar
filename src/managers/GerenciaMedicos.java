...
public class GerenciaMedicos {
    ...
    public boolean verificarMed(){
        String id;
        String senha;
        boolean medicoEncontrado = false;

        System.out.println("--==[Log in de Médicos]==--");
        System.out.println("Digite a identidade do médico que deseja fazer Log in: ");
        id = ent.nextLine();

        System.out.println("Digite a senha relacionada a esse médico:");
        senha = ent.nextLine();

        for (Medico medico : medicos) {
            if (medico != null && medico.getIdentidade().equals(id)) {
